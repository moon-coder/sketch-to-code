    ...
    plugins: [
      new HtmlWebpackPlugin(
        Object.assign(
          {},
          {
            dllName: isEnvProduction
              ? require('./compile-env.json').prodDll
              : require('./compile-env.json').testDll,
            inject: true,
      ...
      new webpack.DllReferencePlugin({
        manifest: isEnvProduction
          ? require('../public/javascript/dll/vendor-manifest-prod.json')
          : require('../public/javascript/dll/vendor-manifest.json') // eslint-disable-line
      }),
